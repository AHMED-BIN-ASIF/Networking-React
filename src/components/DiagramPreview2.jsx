...
const connectionMap = {
  ...
  'chk-priv-inet': [
    ...
    ['top2-priv-2', 'top2-gateway-2'],
    ['top2-gateway-2', 'top2-inet-1']
  ],
    ...
    <div className="diagram-topology-two">
      ...
      <div className="topo-img-wrapper">
        ...
        <div className="network-label-grp nlg-1">
          <span className="network-label-name" id="vpc-name-2">{formData.hubVcnName}</span>
          <span className="network-label-domain" id="vcn-cidr-2">{formData.hubVcnCidr}</span>
        </div>
        <div className="network-label-grp nlg-2">
          <span className="network-label-name" id="public-name-">{formData.hubPrivSubnetName}</span>
          <span className="network-label-domain" id="public-cidr-1">{formData.hubPrivSubnetCidr}</span>
        </div>
        <div className="network-label-grp nlg-3">
          <span className="network-label-name" id="private-name-1">{formData.hubPubSubnetName}</span>
      ...
      {popupwrap && 
        ...
        <Popup id="popup1" title={formData.hubPrivSlName} isVisible={popups.popup1} onClose={() =>
        ...
        <Popup id="popup2" title={formData.hubPubSlName} isVisible={popups.popup2} onClose={() =>
        ...
        <Popup id="popup3" title={formData.spokeAPrivSlName} isVisible={popups.popup3} onClose={() =>
        ...
        <Popup id="popup4" title={formData.spokeBPrivSlName} isVisible={popups.popup4} onClose={() =>
        ...
        <Popup id="popup5" title={formData.hubPrivRtName} isVisible={popups.popup5} onClose={() =>
        ...
        <Popup id="popup6" title={formData.hubPubRtName} isVisible={popups.popup6} onClose={() =>
