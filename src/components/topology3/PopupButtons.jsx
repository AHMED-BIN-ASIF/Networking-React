...
const PopupButtons = ({ formData, setPopups, updatedPopups, flowCheckboxes }) => {
  const popupConfig = [
    { id: "popup1", className: "orange top1-btn-1", label: formData.hubPrivSlName },
    { id: "popup2", className: "orange top1-btn-2", label: formData.hubPubSlName },
    { id: "popup3", className: "blue top1-btn-3", label: formData.spokeAPrivSlName },
    { id: "popup4", className: "blue top1-btn-4", label: formData.spokeBPrivSlName },
    { id: "popup5", className: "orange top1-btn-5", label: formData.hubPrivRtName },
    { id: "popup6", className: "orange top1-btn-6", label: formData.hubPubRtName },
    { id: "popup7", className: "blue top1-btn-7", label: formData.spokeAPrivRtName },
    { id: "popup8", className: "blue top1-btn-8", label: formData.spokeBPrivRtName },
    ...
    { id: "popup18", className: "green top1-btn-18", label: formData.onPremRouteTable },
    { id: "popup19", className: "green top1-btn-19", label: formData.tunnelRouteTable1 },
    { id: "popup20", className: "green top1-btn-20", label: formData.tunnelRouteTable2 },
  ];
