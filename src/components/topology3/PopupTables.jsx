...
const PopupTables = ({ formData, popups, setPopups, flowCheckboxes }) => {
        ...
        <table>
          ...
          <tbody>
            ...
            {(flowCheckboxes["chk-op1-fw1-priv1"] ||
              ...
              <tr className="green-row">
                <td>{formData.onPremSubnetCidr}</td>
                <td>Dynamic Routing Gateway</td>
                <td>DRG</td>
                <td>Static</td>
              </tr>
        ...
        <table>
          ...
          <tbody>
            ...
            {(flowCheckboxes["chk-op1-pub1"] ||
              ...
              <tr>
                <td className="green-row">{formData.onPremSubnetCidr}</td>
                <td>Private IP</td>
                <td className="red-row">{formData.firewallIp}</td>
                <td>Static</td>
              </tr>
            ...
            {flowCheckboxes["chk-priv3-db1"] && (
              <tr>
                <td className="blue-row">
                  All CDG Services In Oracle Services...
                </td>
                <td>Dynamic Routing Gateway</td>
                <td>DRG</td>
                <td>Static</td>
  ...
  <td>RT-DRG-Tun-2</td>
          ...
          <tbody>
            ...
            {(flowCheckboxes["chk-priv1-fw1-op1"] ||
              ...
              <>
                ...
                <tr>
                  <td className="orange-row">{formData.hubPrivSubnetCidr}</td>
                  <td>Private IP</td>
                  <td className="red-row">{formData.firewallIp}</td>
                  <td>Static</td>
                </tr>
            ...
            {(flowCheckboxes["chk-op1-pub1"] ||
              ...
              <>
                ...
                <tr>
                  <td className="orange-row">{formData.hubPubSubnetCidr}</td>
                  <td>Private IP</td>
                  <td className="red-row">{formData.firewallIp}</td>
                  <td>Static</td>
                </tr>
      ...
      <Popup
        id="popup18"
        title={formData.onPremRouteTable}
        isVisible={popups.popup18}
        onClose={() => setPopups((prev) => ({ ...prev, popup18: false }))}
      >
        <table>
          <thead>
            <tr>
      ...
      <Popup
        id="popup19"
        title={formData.tunnelRouteTable1}
        isVisible={popups.popup19}
        onClose={() => setPopups((prev) => ({ ...prev, popup19: false }))}
      >
        <table>
          <thead>
            <tr>
      ...
      <Popup
        id="popup20"
        title={formData.tunnelRouteTable2}
        isVisible={popups.popup20}
        onClose={() => setPopups((prev) => ({ ...prev, popup20: false }))}
      >
        <table>
          <thead>
            <tr>
